...
| Secret scanning baseline | Verify no secrets/tokens are committed | [`.github/workflows/secret-scan.yml`](../../../.github/workflows/secret-scan.yml), [`docs/adr/0005-no-secrets-in-repository.md`](../../../docs/adr/0005-no-secrets-in-repository.md) | Rotate/revoke and remove exposed credentials immediately | 2026-05-03 |
